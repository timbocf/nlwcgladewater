...
// Set theme base URL 
$imagesURL = 'wp-content/themes/nlwc/';
...
function list_sermons() {
	...
	foreach($files as $filename)
	{
		...
		echo('<li class="gallery-item"><div class="file"><a href="../wp-content/uploads/' . $filename . '" rel="0" class="newWindow">' . $trim . '</a></div><div class="speaker">' . $speakertrim . '</div>' . '<div class="date">' . $date . '</div></li>');
	}
}